            ...
            >
              ...
              <div style="text-align: justify">
                <p>
                  ...
                  iklan dan pemasaran kami. Beberapa data anonim yang kami ambil
                  adalah versi sistem operasi Anda, versi browser, dan alamat
                  IP. Apa itu Informasi yang Anda Berikan? Informasi yang Anda
                  kirim melalui formulir online kami, seperti nama Anda, nomor
                  telepon, dan alamat email, diambil dan disimpan agar Metro
                  Jaya Indonesia dapat melakukan kontak melalui nomor telepon
                  maupun alamat email yang telah Anda dan pengunjung kami yang
                  lain berikan baik yang berhubungan dengan proses transaksi di
                  website ataupun tidak. Dengan mengirimkan informasi secara
                  sukarela, Anda memberi wewenang Metro jaya Indonesia untuk
                  menghubungi Anda melalui telepon, teks, email atau surat.
                ...
                <p class="mt-2 ms-4 m-0">
                  ...
                  yang Kami lakukan kepada Anda dan pihak lain, serta menyajikan
                  iklan produk dan jasa yang relevan bagi Anda untuk memberi
                ...
                <p class="ms-4">
                  ...
                  jasa lain yang Kami tawarkan; guna menyediakan Anda, atau
                  mengizinkan pihak ketiga untuk menyediakan Anda informasi
                  tentang produk dan jasa yang Kami anggap dapat menarik minat
                  Anda. Jika Anda adalah pelanggan lama, Kami dapat menghubungi
                  Anda secara elektronik atau cara-cara lain dengan informasi
                  tentang produk dan jasa Kami. Jika Anda adalah pelanggan baru,
                  dan di mana Kami mengizinkan pihak ketiga untuk menggunakan
                  Data Pribadi Anda, Kami (atau mereka) dapat menghubungi Anda
                  secara elektronik hanya jika Anda sudah memberikan persetujuan
                  untuk memberitahukan Anda tentang perubahan pada jasa Kami
                  untuk memastikan bahwa konten dari situs Kami disajikan dengan
