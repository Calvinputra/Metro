...
<div class="container-fluid">
    ...
    @endcan
    @can('import', app($dataType->model_name))
    <a href="#" onclick="$('#import_modal').modal('show');" class="btn btn-warning btn-add-new">
        <i class="voyager-upload"></i> <span>Import Data</span>
    </a>
    @endcan
...
@include("vendor.voyager.products.components.import_modal");
@stop
